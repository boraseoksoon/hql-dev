// src/s-exp/core-macros.ts - Core macros for the S-expression layer
...
*/
export function initializeCoreMacros(env: SEnv, logger: Logger): void {
logger.debug('Initializing core macros');

// defn: Define a function
// (defn name [params...] body...)
// Expands to: (def name (fn [params...] body...))
env.defineMacro('defn', (args: SExp[], env: SEnv): SExp => {
if (args.length < 2) {
...
env.defineMacro('or', (args: SExp[], env: SEnv): SExp => {
if (args.length === 0) {
...
env.defineMacro('and', (args: SExp[], env: SEnv): SExp => {
if (args.length === 0) {
...
env.defineMacro('not', (args: SExp[], env: SEnv): SExp => {
if (args.length !== 1) {
...
env.defineMacro('do', (args: SExp[], env: SEnv): SExp => {
if (args.length === 0) {
...
env.defineMacro('cond', (args: SExp[], env: SEnv): SExp => {
if (args.length === 0) {
 return createNilLiteral();
}
...
env.defineMacro('when', (args: SExp[], env: SEnv): SExp => {
if (args.length < 1) {
...
env.defineMacro('unless', (args: SExp[], env: SEnv): SExp => {
if (args.length < 1) {
...
// (inc x)
// Expands to: (+ x 1)
env.defineMacro('inc', (args: SExp[], env: SEnv): SExp => {
if (args.length !== 1) {
...
// (dec x)
// Expands to: (- x 1)
env.defineMacro('dec', (args: SExp[], env: SEnv): SExp => {
if (args.length !== 1) {
...
env.defineMacro('let', (args: SExp[], env: SEnv): SExp => {
if (args.length < 1) {
...
env.defineMacro('if-let', (args: SExp[], env: SEnv): SExp => {
...
// nth: Get element at index (alias for get)
// (nth coll idx)
// Expands to: (get coll idx)
env.defineMacro('nth', (args: SExp[], env: SEnv): SExp => {
if (args.length !== 2) {
...
env.defineMacro('str', (args: SExp[], env: SEnv): SExp => {
if (args.length === 0) {
...
env.defineMacro('print', (args: SExp[], env: SEnv): SExp => {
return createList(
...
env.defineMacro('contains?', (args: SExp[], env: SEnv): SExp => {
if (args.length !== 2) {
...
logger.debug('Defined contains? macro');

// Export functions for import handling
env.define('lodash-capitalize', (s: string) => {
