...
import { formatErrorMessage } from "./common-error-utils.ts";
...
export class Logger {
  ...
  /**
   * Create a new Logger instance with the specified verbose setting
   * This is useful when you need a logger in a module but don't want to affect the global singleton
   */
