...
isNodeMode || !mod2 || !mod2.__esModule ? __defProp(target, "default", { value: mod2, enumerable: true }) : target, mod2));
...
var a_ = (l, Q, bn, re) => {
    if (Q && typeof Q == "object" || typeof Q == "function")
        for (let z of f_(Q))
            !o_.call(l, z) && z !== bn && il(l, z, { get: () => Q[z], enumerable: !(re = u_(Q, z)) || re.enumerable });
    return l;
};
    ...
    (function () {
        ...
        var Qo = function a(g) {
            ...
            function mu(n, t) {
                ...
                for (var p in n)
                    (t || B.call(n, p)) && !(o && (p == "length" || i && (p == "offset" || p == "parent") || f && (p == "buffer" || p == "byteLength" || p == "byteOffset") || Gn(p, c))) && s.push(p);
                return s;
            }
            function Iu(n) {
                var t = n.length;
            ...
            function dn(n, t, e, r, i, f) {
                ...
                if (_) {
                    ...
                    if (d == Pn || d == vt || v && !i) {
                        if (o = c || v ? {} : pf(n), !s)
                            return c ? ma(n, $s(o, n)) : ya(n, Ru(o, n));
                    }
                    else {
                        if (!M[d])
                            return i ? n : {};
            ...
            function Xs(n, t, e, r) {
                var i = n.length;
                for (e = S(e), e < 0 && (e = -e > i ? 0 : i + e), r = r === l || r > i ? i : S(r), r < 0 && (r += i), r = e > r ? 0 : $f(r); e < r;)
                    n[e++] = t;
                return n;
            }
            function Tu(n, t) {
            ...
            function ta(n, t, e, r, i, f) {
                ...
                if (v && !_)
                    return f || (f = new In()), o || Ot(n) ? cf(n, t, e, r, i, f) : Ta(n, t, c, e, r, i, f);
                if (!(e & pt)) {
            ...
            function qr(n, t, e, r) {
                ...
                for (n === t && (t = nn(t)), e && (s = D(n, fn(e))); ++f < o;)
            ...
            function $r(n, t, e, r) {
                ...
                for (var o = t !== t, s = t === null, c = on(t), p = t === l; i < f;) {
                    ...
                    if (o)
                        ...
                        p ? m = y && (r || v) : s ? m = y && v && (r || !x) : c ? m = y && v && !x && (r || !E) : x || E ? m = false : m = r ? d <= t : d < t;
                    m ? i = _ + 1 : f = _;
                }
                return X(f, _l);
            }
            ...
            function Vu(n, t, e, r) {
                for (var i = -1, f = n.length, o = e.length, s = -1, c = t.length, p = K(f - o, 0), _ = h(c + p), d = !r; ++s < c;)
                    _[s] = t[s];
                for (; ++i < o;)
                    (d || i < f) && (_[e[i]] = n[i]);
                for (; p--;)
            ...
            function ku(n, t, e, r) {
                for (var i = -1, f = n.length, o = -1, s = e.length, c = -1, p = t.length, _ = K(f - s, 0), d = h(_ + p), v = !r; ++i < _;)
                    d[i] = n[i];
                for (var x = i; ++c < p;)
                    d[x + c] = t[c];
                for (; ++o < s;)
            ...
            function Ra(n, t, e) {
                ...
                function i() {
                    ...
                    if (f -= p.length, f < e)
                        return lf(n, t, Ue, i.placeholder, l, o, p, l, l, e - f);
            ...
            function Ue(n, t, e, r, i, f, o, s, c, p) {
                ...
                function m() {
                    for (var T = arguments.length, O = h(T), sn = T; sn--;)
                        O[sn] = arguments[sn];
                    if (x)
                        var j = Ct(m), an = Fo(O, j);
            ...
            function Sa(n, t, e, r) {
                var i = t & cn, f = kt(n);
                function o() {
                    for (var s = -1, c = arguments.length, p = -1, _ = r.length, d = h(_ + c), v = this && this !== $ && this instanceof o ? f : n; ++p < _;)
                        d[p] = r[p];
                    for (; c--;)
                        d[p++] = arguments[++s];
            ...
            function Un(n, t, e, r, i, f, o, s) {
                ...
                if (v && Ha(x, v), n = x[0], t = x[1], e = x[2], r = x[3], i = x[4], s = x[9] = x[9] === l ? c ? 0 : n.length : K(x[9] - p, 0), !s && t & (En | _t) && (t &= ~(En | _t)), !t || t == cn)
                    var y = Ia(n, t, e);
                else
                    t == En || t == _t ? y = Ra(n, t, s) : (t == Ln || t == (cn | Ln)) && !i.length ? y = Sa(n, t, e, r) : y = Ue.apply(l, x);
                var E = v ? Hu : xf;
                return Af(E(y, x), n, t);
            }
            function sf(n, t, e, r) {
            ...
            function cf(n, t, e, r, i, f) {
                ...
                for (f.set(n, t), f.set(t, n); ++d < s;) {
                    var y = n[d], E = t[d];
                    if (r)
                        var m = o ? r(E, y, d, t, n, f) : r(y, E, d, n, t, f);
                    if (m !== l) {
                        if (m)
                            continue;
                        v = false;
            ...
            function Ca(n, t, e, r, i, f) {
                ...
                for (var m = o; ++d < c;) {
                    ...
                    var T = n[v], O = t[v];
                    if (r)
                        var sn = o ? r(O, T, v, t, n, f) : r(T, O, v, n, t, f);
...
`);
            ...
            function Jh(n) {
                if (n == null)
                    return true;
                if (tn(n) && (R(n) || typeof n == "string" || typeof n.splice == "function" || tt(n) || Ot(n) || ht(n)))
                    return !n.length;
                var t = J(n);
                if (t == An || t == yn)
                    return !n.size;
            ...
            function dp(n, t) {
                ...
                if (o && (s += c.length - s), gi(i)) {
                    if (n.slice(s).search(i)) {
                        var p, _ = c;
                        for (i.global || (i = Cr(i.source, b(Wi.exec(i)) + "g")), i.lastIndex = 0; p = i.exec(_);)
                            var d = p.index;
                        c = c.slice(0, d === l ? s : d);
                    }
                }
...
function hasFlag(flag, argv = dntShim.Deno.args) {
...
function isatty(fd2) {
    ...
    try {
        return dntShim.Deno.isatty(fd2);
    }
    catch (_) {
        return false;
    }
...
var env = dntShim.Deno.env.toObject();
var flagForceColor;
...
function _supportsColor(haveStream, { streamIsTTY, sniffFlags = true } = {}) {
    ...
    if (dntShim.Deno.build.os === "win32") {
        return 1;
    }
    if ("CI" in env) {
...
var AnsiStyles = class {
    get styles() {
        ...
        for (const [styleName, style] of Object.entries(base_styles.modifier)) {
            modifier[styleName] = {
                open: `\x1B[${style[0]}m`,
                close: `\x1B[${style[1]}m`
            };
...
function hasFlag2(flag, argv = dntShim.dntGlobalThis.Deno ? dntShim.dntGlobalThis.Deno.args : node_process_1.default.argv) {
    const prefix = flag.startsWith("-") ? "" : flag.length === 1 ? "-" : "--";
    const position = argv.indexOf(prefix + flag);
    const terminatorPosition = argv.indexOf("--");
    return position !== -1 && (terminatorPosition === -1 || position < terminatorPosition);
}
var { env: env2 } = node_process_1.default;
var flagForceColor2;
...
var supportsColor2 = {
    stdout: createSupportsColor2({ isTTY: node_tty_1.default.isatty(1) }),
    stderr: createSupportsColor2({ isTTY: node_tty_1.default.isatty(2) })
};
...
var getModelAnsi2 = (model, level, type, ...arguments_) => {
    if (model === "rgb") {
        if (level === "ansi16m") {
            return ansi_styles_default2[type].ansi16m(arguments_[0], arguments_[1], arguments_[2]);
        }
        if (level === "ansi256") {
            return ansi_styles_default2[type].ansi256(ansi_styles_default2.rgbToAnsi256(arguments_[0], arguments_[1], arguments_[2]));
        }
        return ansi_styles_default2[type].ansi(ansi_styles_default2.rgbToAnsi(arguments_[0], arguments_[1], arguments_[2]));
    }
    if (model === "hex") {
        return getModelAnsi2("rgb", level, type, ...ansi_styles_default2.hexToRgb(arguments_[0]));
    }
...
for (const model of usedModels2) {
    styles2[model] = {
        get() {
            ...
            const { level } = current;
            return function (...arguments_) {
                const styler = createStyler2(getModelAnsi2(model, levelMapping2[level], "color", ...arguments_), ansi_styles_default2.color.close, current[STYLER2]);
    ...
    styles2[bgModel] = {
        get() {
            ...
            const { level } = current;
            return function (...arguments_) {
                const styler = createStyler2(getModelAnsi2(model, levelMapping2[level], "bgColor", ...arguments_), ansi_styles_default2.bgColor.close, current[STYLER2]);
                return createBuilder2(current, styler, current[IS_EMPTY2]);
            };
        }
    };
...
// data:text/javascript;base64,
...
function greetRemote(name) {
    return Vw.upperCase("Hello, ") + name + "!";
}
