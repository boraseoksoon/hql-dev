...
const syncAdd = (function(x, y) { return x + y; });
const syncMinus = (function(x, y) { return x - y; });
const add2 = (function(x, y) { return x + y; });
const minus2 = (function(x, y) { return x - y; });
const Destination = { hlvm: "hlvm", macos: "macos", ios: "ios" };
function send(message, to) { return message; }
function send2(message, to) { return message; }
