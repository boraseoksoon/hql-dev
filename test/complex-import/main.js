import * as configMod from "./config/main-config.js";
import * as utilsMod from "./utils/string-utils.js";
import * as mathMod from "./utils/math/operations.js";
import * as jsHelperMod from "./helpers/js-helper.js";
import * as dateMod from "./utils/date-formatter.js";
import * as pathMod from "https://deno.land/std@0.170.0/path/mod.ts";
import * as fsMod from "https://deno.land/std@0.170.0/fs/mod.ts";
import * as uuidMod from "https://deno.land/std@0.170.0/uuid/mod.ts";
...
import * as chalkMod from "https://deno.land/x/chalk_deno@v4.1.1-deno/source/index.js";
...
const multiply = return function(a, b) {
  return (a * b);
};
