...
;; Compiler must gurantee pure immutability for example, the following Javascript interop case should be transformed inernally
;; (let numbers (new Array)) → to: (let numbers (freeze (new Array)))
;; to gurantee immutability
