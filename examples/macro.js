...
var test_empty_cond = function() {
  return null;
};
console.log("Testing empty cond:", test_empty_cond());
var test_nested_cond = function(x, y) {
...
console.log("Testing nested cond with (0, 5):", test_nested_cond(0, 5));
console.log("\\n=== Testing 'when' macro ===");
var test_when = function(value) {
  console.log("Testing when with value:", value);
  return value > 0 ? function(temp) {
    temp();
    return null;
  }(function() {
...
var test_let_multiple = function() {
  return function(x) {
    return function(y) {
      return function(z) {
        return function(temp) {
...
var test_if_let = function(value) {
...
var calculate_area = function(radius) {
