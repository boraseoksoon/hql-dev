...
import * as macroBModule from "./macro-b.hql";
const macroB = (function () {
    const wrapper = macroBModule.default !== undefined ? macroBModule.default : {};
    for (const [key, value] of Object.entries(macroBModule)) {
        if (key !== "default")
            wrapper[key] = value;
    }
    return wrapper;
})();
import * as macroCModule from "./macro-c.hql";
const macroC = (function () {
    const wrapper = macroCModule.default !== undefined ? macroCModule.default : {};
