...
const utils = (function () {
    const wrapper = utilsModule.default !== undefined ? utilsModule.default : {};
    for (const [key, value] of Object.entries(utilsModule)) {
        if (key !== "default")
            wrapper[key] = value;
    }
    return wrapper;
...
null;
null;
const double_five = utils.double(5);
const doubled_and_added = utils.double(5);
export { double_five };
export { doubled_and_added };
